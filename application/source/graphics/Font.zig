...
pub fn init(allocator: Allocator, file: []const u8, size: f32) !Self {
...
pub fn loadCodePoints(self: *Self, codePoints: []CodePoint) !void {
...
fn loadGlyph(self: *Self, codePoint: CodePoint) !void {
